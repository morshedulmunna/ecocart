    ...
    <Card className="h-full">
      ...
      <CardContent>
        <div className="relative aspect-square w-full overflow-hidden rounded-md bg-accent">
          {product.image_url ? <Image src={product.image_url} alt={product.name} fill className="object-cover transition-transform duration-300 hover:scale-105" /> : <div className="flex h-full items-center justify-center text-muted-foreground">No image</div>}
        </div>
